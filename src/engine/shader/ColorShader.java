...
public class ColorShader extends Shader {
    ...
    public void bindAllAttributes() {
        ...
        super.bindAttribute(1, "inColorPalette");
    ...
    public void load(Matrix4f modelMatrix, Material material) {
        super.loadIntUniform(typeLocation, 0);
    ...
    private void setupSpotLights(SpotLight spotLight, int index) {
        ...
        super.loadFloatUniform(spotLightCutoffLocations[index], (float) Math.cos(spotLight.getCutoff()));
