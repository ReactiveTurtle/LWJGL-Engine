...
public class Interface {
    ...
    public void notify(Static staticObject) {
        clearDrawer(takeNotificationDrawer, takeNotificationImage.getWidth(), takeNotificationImage.getHeight());
        if (staticObject != null) {
            takeNotificationDrawer.drawString(staticObject.name, takeNotificationImage.getWidth() / 2f - staticObject.name.length() * 6, 24);
            if (staticObject instanceof Collectable && staticObject.name.length() > 0) {
                takeNotificationDrawer.drawString("Press E", takeNotificationImage.getWidth() / 2f - 48, 52);
            }
        }
